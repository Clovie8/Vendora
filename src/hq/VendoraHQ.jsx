          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={submitRenewal} className="p-5 space-y-4">
              ...
              <button 
                type="submit" 
                disabled={isLoading}
                className="w-full bg-[#0B2B5E] hover:bg-blue-900 disabled:bg-blue-900/70 disabled:cursor-not-allowed text-white font-bold py-3 rounded-xl mt-4 transition-all flex justify-center items-center"
              >
                {isLoading ? (
                  <>
