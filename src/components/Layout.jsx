          ...
          {(userRole === 'Admin' || userRole === 'Manager') && (
            <>
              ...
              <SidebarLink to="/credits" label="Credit Management" active={isActive('/credits')} isCollapsed={isSidebarCollapsed}>
               ...
               <SidebarLink to="/contacts" label="Contacts" active={isActive('/contacts')} isCollapsed={isSidebarCollapsed}>
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.858M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.858M7 20H2v-2a3 3 0 015.356-1.858M7 20v-2c0-.656.126-1.283.356-1.858"></path></svg>
              </SidebarLink>
